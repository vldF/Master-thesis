...
Существует большое число подходов, призванных решить задачу расширения базы знаний SAST анализатора кода. В рамках данной работы, их можно классифицировать по следующим признакам:
  ...
  - Возможность интеграции в PT JSA
...
Данный раздел содержит обзор существующих подходов, реализованных в существующих продуктах или представленных в академических работах. Каждый из подходов оценивается с помощью критериев, приведённых в Разделе 1.1. 
...
- Отсутствует возможность интеграции в анализатор кода PT JSA
