...
Таким образом, необходимо разработать синтаксис и семантику прототипа DSL и интегрировать его в анализатор PT JSA. Он должен соответствовать следующим требованиям:
